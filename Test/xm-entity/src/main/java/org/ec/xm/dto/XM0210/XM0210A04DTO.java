...
/**
 * XM0210/A04 资金信息获取: 返回结果
 * 设计者:   李科
 * 更新日期: 2018/4/26
 */
public class XM0210A04DTO extends ResponseDTO {
     ...
     * 资金来源
     */
    private List<XM0210A04S01DTO> moneySource;
     ...
     */
    public List<XM0210A04S01DTO> getMoneySource() {
        return moneySource;
    }
     ...
     */
    public void setMoneySource(List<XM0210A04S01DTO> moneySource) {
    ...
    public void setSuperMoney(Double superMoney) {
        this.superMoney = superMoney;
    }
