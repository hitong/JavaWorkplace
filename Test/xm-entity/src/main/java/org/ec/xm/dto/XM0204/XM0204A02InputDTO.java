...
/**
 * XM0204/A02 任务新增提交: 请求参数
 * 设计者:   李科
 * 更新日期: 2018/4/26
 */
public class XM0204A02InputDTO extends RequestDTO {
    ...
    /**
     * 获取 创建组织ID
     * @return createdOrganizationId 创建组织ID
     */
    @ApiModelProperty(value = "创建组织ID", name = "createdOrganizationId", dataType = "Integer")
    ...
    /**
     * 设置 创建组织ID
     * @param createdOrganizationId 创建组织ID
     */
