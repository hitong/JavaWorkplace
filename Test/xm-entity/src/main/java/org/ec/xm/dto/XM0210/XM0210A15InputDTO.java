...
/**
 * XM0210/A15 资金下达编辑提交(区县): 请求参数
 * 设计者:   李科
 * 更新日期: 2018/4/26
 */
public class XM0210A15InputDTO extends RequestDTO {
     ...
     * @return money 金额
     */
    @ApiModelProperty(value = "金额", name = "money", dataType = "Float[]")
    ...
    /**
     * 设置 当前组织ID
     * @param curOrganizationId 当前组织ID
     */
    public void setCurOrganizationId(Integer curOrganizationId) {
